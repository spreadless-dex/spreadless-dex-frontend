        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              style={
                walletConnected
                  ? { borderColor: 'var(--c-border)', color: 'var(--c-text-muted)' }
      ...
      {menuOpen && (
        ...
        >
          ...
          <nav
            ...
            style={{
              backgroundColor: 'color-mix(in srgb, var(--c-surface) 96%, transparent)',
              borderColor: 'var(--c-border)',
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col gap-1">
                ...
                <a
                  ...
                  style={{
                    color: currentPage === page
                      ...
                      ? 'var(--c-text-faint)'
                      : 'var(--c-text-muted)',
                    backgroundColor: currentPage === page ? 'var(--c-surface-2)' : 'transparent',
                  }}
                >
                  {label}
                  {currentPage === page && (
              ...
              <div className="pt-3 mt-1" style={{ borderTop: '1px solid var(--c-border)' }}>
                <button
                  onClick={() => { walletConnected ? disconnectWallet() : connectWallet(); setMenuOpen(false) }}
